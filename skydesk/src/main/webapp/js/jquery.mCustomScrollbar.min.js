...
!function (e, t, a) {
  !function (t) {
        ...
        if ('undefined' != typeof t && null != t) {
          ...
          return e(o).each(function () {
            ...
            if (o.data(i)) {
              ...
              s.moveDragger && (c[0] *= n.scrollRatio.y, c[1] *= n.scrollRatio.x),
              s.dur = d,
              setTimeout(function () {
                null !== c[0] && 'undefined' != typeof c[0] && 'x' !== r.axis && n.overflowed[0] && (s.dir = 'y', s.overwrite = 'all', G(o, c[0].toString(), s)),
                null !== c[1] && 'undefined' != typeof c[1] && 'y' !== r.axis && n.overflowed[1] && (s.dir = 'x', s.overwrite = 'none', G(o, c[1].toString(), s))
              }, s.timeout)
            }
          })
        }
    ...
    _ = function () {
      ...
      l = [
        '<div id=\'mCSB_' + a.idx + '_scrollbar_vertical\' class=\'mCSB_scrollTools mCSB_' + a.idx + '_scrollbar mCS-' + o.theme + ' mCSB_scrollTools_vertical' + r + '\'><div class=\'' + f[12] + '\'><div id=\'mCSB_' + a.idx + '_dragger_vertical\' class=\'mCSB_dragger\' style=\'position:absolute;\' oncontextmenu=\'return false;\'><div class=\'mCSB_dragger_bar\' /></div><div class=\'mCSB_draggerRail\' /></div></div>',
        '<div id=\'mCSB_' + a.idx + '_scrollbar_horizontal\' class=\'mCSB_scrollTools mCSB_' + a.idx + '_scrollbar mCS-' + o.theme + ' mCSB_scrollTools_horizontal' + r + '\'><div class=\'' + f[12] + '\'><div id=\'mCSB_' + a.idx + '_dragger_horizontal\' class=\'mCSB_dragger\' style=\'position:absolute;\' oncontextmenu=\'return false;\'><div class=\'mCSB_dragger_bar\' /></div><div class=\'mCSB_draggerRail\' /></div></div>'
      ],
      ...
      'outside' === o.scrollbarPosition ? ('static' === t.css('position') && t.css('position', 'relative'), t.css('overflow', 'visible'), m.addClass('mCSB_outside').after(c))  : (m.addClass('mCSB_inside').append(c), p.wrap(d)),
      b.call(this);
      var g = [
    ...
    b = function () {
      ...
      l = [
        '<a href=\'#\' class=\'' + f[13] + '\' oncontextmenu=\'return false;\' ' + r + ' />',
        '<a href=\'#\' class=\'' + f[14] + '\' oncontextmenu=\'return false;\' ' + r + ' />',
        '<a href=\'#\' class=\'' + f[15] + '\' oncontextmenu=\'return false;\' ' + r + ' />',
        '<a href=\'#\' class=\'' + f[16] + '\' oncontextmenu=\'return false;\' ' + r + ' />'
      ],
      s = [
        'x' === o.axis ? l[2] : l[0],
        'x' === o.axis ? l[3] : l[1],
    ...
    B = function () {
      ...
      l = [
        n.outerHeight(!1) - o.height(),
        n.outerWidth(!1) - o.width()
      ],
      s = [
    ...
    M = function () {
      ...
      if (Q(t), ('x' !== o.axis && !a.overflowed[0] || 'y' === o.axis && a.overflowed[0]) && (l[0].add(r).css('top', 0), G(t, '_resetY')), 'y' !== o.axis && !a.overflowed[1] || 'x' === o.axis && a.overflowed[1]) {
        var s = dx = 0;
        'rtl' === a.langDir && (s = n.width() - r.outerWidth(!1), dx = Math.abs(s / a.scrollRatio.x)),
        r.css('left', s),
        l[1].css('left', dx),
        G(t, '_resetX')
      }
    ...
    I = function () {
      ...
      o.bindEvents && (e(a).unbind('.' + r), s.each(function () {
        e(this).unbind('.' + r)
    ...
    R = function (t) {
      ...
      'x' !== n.axis && (o.overflowed[0] && !t ? (s[0].add(c[0]).add(s[0].children('a')).css('display', 'block'), l.removeClass(f[8] + ' ' + f[10]))  : (n.alwaysShowScrollbar ? (2 !== n.alwaysShowScrollbar && c[0].css('display', 'none'), l.removeClass(f[10]))  : (s[0].css('display', 'none'), l.addClass(f[10])), l.addClass(f[8]))),
      'y' !== n.axis && (o.overflowed[1] && !t ? (s[1].add(c[1]).add(s[1].children('a')).css('display', 'block'), l.removeClass(f[9] + ' ' + f[11]))  : (n.alwaysShowScrollbar ? (2 !== n.alwaysShowScrollbar && c[1].css('display', 'none'), l.removeClass(f[11]))  : (s[1].css('display', 'none'), l.addClass(f[11])), l.addClass(f[9]))),
    ...
    D = function () {
      ...
      e(a).bind('mousemove.' + h + ' pointermove.' + h + ' MSPointerMove.' + h, function (e) {
        ...
        n && (T(n, 'active', f.autoExpandScrollbar), n = null),
        u = !1,
    ...
    L = function () {
      ...
      B = [
        e('#mCSB_' + S.idx + '_dragger_vertical'),
        e('#mCSB_' + S.idx + '_dragger_horizontal')
      ],
      T = [
      ],
      k = [
      ...
      C.bind('touchstart.' + b + ' pointerdown.' + b + ' MSPointerDown.' + b, function (e) {
        ...
        if (tt(e) && !u && !E(e) [2]) {
          ...
          if (!(f - d > 30)) {
            ...
            var M = [
              Math.abs(y[0].offsetTop) - h[0] * t(B[0] / m[0], m[0]),
              Math.abs(y[0].offsetLeft) - h[1] * t(B[1] / m[1], m[1])
            ];
            p = 'yx' === w.axis ? [
              M[0],
              M[1]
            ...
            g = [
              4 * B[0] + w.scrollInertia,
              4 * B[1] + w.scrollInertia
            ];
      ...
      if (o) {
        ...
        u.bind('mousewheel.' + r, function (t, i) {
          if (Q(a), !P(a, t.target)) {
            ...
            f = 'auto' !== n.mouseWheel.scrollAmount ? u[1] : u[0] >= l.width() ? 0.9 * l.width()  : u[0],
            ...
            f = 'auto' !== n.mouseWheel.scrollAmount ? u[1] : u[0] >= l.height() ? 0.9 * l.height()  : u[0],
      ...
      l.bind('touchstart.' + o + ' pointerdown.' + o + ' MSPointerDown.' + o, function () {
        ...
        if (e(o.target).hasClass(f[12]) || e(o.target).hasClass('mCSB_draggerRail')) {
          ...
          if (i.parent('.mCSB_scrollTools_horizontal').length > 0) {
            ...
            d = Math.abs(n[0].offsetLeft) - 0.9 * c * r.width()
          } else {
            if (!a.overflowed[0]) return;
            var s = 'y',
            c = o.pageY > l.offset().top ? - 1 : 1,
            d = Math.abs(n[0].offsetTop) - 0.9 * c * r.height()
          }
          G(t, d.toString(), {
            dir: s,
            scrollEasing: 'mcsEaseInOut'
    ...
    H = function () {
      ...
      l.bind('focusin.' + r, function () {
        ...
        o.is(n.advanced.autoScrollOnFocus) && (Q(t), clearTimeout(t[0]._focusTimeout), t[0]._focusTimer = i ? (r + 17) * i : 0, t[0]._focusTimeout = setTimeout(function () {
          ...
          i = [
            a[0] + e[0] >= 0 && a[0] + e[0] < s.height() - o.outerHeight(!1),
            a[1] + e[1] >= 0 && a[0] + e[1] < s.width() - o.outerWidth(!1)
          ],
        ...
        switch (i.type) {
          ...
          case 'keyup':
            ...
            if ('x' !== n.axis && (38 === s || 40 === s) || 'y' !== n.axis && (37 === s || 39 === s)) {
              ...
              'keyup' === i.type && (f = 'off'),
              e(a.activeElement).is(u) || (i.preventDefault(), i.stopImmediatePropagation(), l(f, s))
            } else if (33 === s || 34 === s) {
    ...
    j = function (t, a, o, n, r) {
      ...
      switch (a) {
        case 'on':
          if (u.dir = [
            o === f[16] || o === f[15] || 39 === o || 37 === o ? 'x' : 'y',
            o === f[13] || o === f[15] || 38 === o || 37 === o ? - 1 : 1
          ], Q(t), at(o) && 'stepped' === u.type) return;
          l(m);
          break;
        case 'off':
          s(),
    ...
    Y = function (t) {
      ...
      t instanceof Array ? o = t.length > 1 ? [
        ...
        t[0],
        null
      ] : (o[0] = t.y ? t.y : t.x || 'x' === a.axis ? null : t, o[1] = t.x ? t.x : t.y || 'y' === a.axis ? null : t),
    ...
    N = function (t) {
      function a() {
        ...
        u[0].autoUpdate = setTimeout(function () {
          return d.advanced.updateOnSelectorChange && (m = r(), m !== S) ? (l(3), void (S = m))  : (d.advanced.updateOnContentResize && (p = [
            u.outerHeight(!1),
            u.outerWidth(!1),
            v.height(),
            v.width(),
            _() [0],
            _() [1]
          ], (p[0] !== w[0] || p[1] !== w[1] || p[2] !== w[2] || p[3] !== w[3] || p[4] !== w[4] || p[5] !== w[5]) && (l(p[0] !== w[0] || p[1] !== w[1]), w = p)), d.advanced.updateOnImageLoad && (g = o(), g !== b && (u.find('img').each(function () {
            n(this)
      ...
      _ = function () {
        return [x[0].is(':visible') ? x[0].outerHeight(!0)  : 0,
    ...
    G = function (t, a, o) {
      ...
      function r() {
        return [c.callbacks.alwaysTriggerOffsets || _ >= S[0] + b,
      ...
      m = h.parent(),
      p = c.callbacks.onTotalScrollOffset ? Y.call(t, c.callbacks.onTotalScrollOffset)  : [
        0,
        0
      ],
      g = c.callbacks.onTotalScrollBackOffset ? Y.call(t, c.callbacks.onTotalScrollBackOffset)  : [
        0,
        0
      ];
      if (s.trigger = o.trigger, (0 !== m.scrollTop() || 0 !== m.scrollLeft()) && (e('.mCSB_' + s.idx + '_scrollbar').css('visibility', 'visible'), m.scrollTop(0).scrollLeft(0)), '_resetY' !== a || s.contentReset.y || (n('onOverflowYNone') && c.callbacks.onOverflowYNone.call(t[0]), s.contentReset.y = 1), '_resetX' !== a || s.contentReset.x || (n('onOverflowXNone') && c.callbacks.onOverflowXNone.call(t[0]), s.contentReset.x = 1), '_resetY' !== a && '_resetX' !== a) {
        ...
        t[0].mcs || (l(), n('onInit') && c.callbacks.onInit.call(t[0])),
        clearTimeout(h[0].onCompleteTimeout),
        (s.tweenRunning || !(0 === _ && w[0] >= 0 || _ === S[0] && w[0] <= S[0])) && (J(v[0], x, Math.round(w[1]), u[1], o.scrollEasing), J(h[0], x, Math.round(w[0]), u[0], o.scrollEasing, o.overwrite, {
          onStart: function () {
          ...
          onComplete: function () {
            if (o.callbacks && o.onComplete) {
              ...
              h[0].onCompleteTimeout = setTimeout(function () {
                n('onScroll') && (l(), c.callbacks.onScroll.call(t[0])),
                n('onTotalScroll') && w[1] >= S[1] - y && s.cbOffsets[0] && (l(), c.callbacks.onTotalScroll.call(t[0])),
                n('onTotalScrollBack') && w[1] <= B && s.cbOffsets[1] && (l(), c.callbacks.onTotalScrollBack.call(t[0])),
                s.tweenRunning = !1,
                h[0].idleTimer = 0,
                T(v, 'hide')
              }, e)
    ...
    J = function (e, a, o, n, i, r, l) {
      ...
      function c() {
        n > 0 ? (b.currVal = f(b.time, S, C, n, i), w[a] = Math.round(b.currVal) + 'px')  : w[a] = o + 'px',
        g.call()
      }
      function d() {
        h = 1000 / 60,
      ...
      function f(e, t, a, o, n) {
        switch (n) {
          ...
          case 'easeInOutSmooth':
            return e /= o / 2,
            1 > e ? a / 2 * e * e + t : (e--, - a / 2 * (e * (e - 2) - 1) + t);
          case 'easeInOutStrong':
            return e /= o / 2,
            1 > e ? a / 2 * Math.pow(2, 10 * (e - 1)) + t : (e--, a / 2 * ( - Math.pow(2, - 10 * e) + 2) + t);
          case 'easeInOut':
          case 'mcsEaseInOut':
            return e /= o / 2,
            1 > e ? a / 2 * e * e * e + t : (e -= 2, a / 2 * (e * e * e + 2) + t);
          case 'easeOutSmooth':
            return e /= o,
            e--,
            - a * (e * e * e * e - 1) + t;
