...
function resetsearch() {
	$('#sguestname,#svtname,#svtid,#svipno,#shouseid,#shousename,#sfkhouseid,#sfkhousename,#slastop,#soperant').val("");
	$("#sfs").val(2);
...
function searchpage(page) {
	...
	currentdata = {
		...
		cxfs: 1,
		fs: fs,
// 		sortlist: (sortlist==""?"ID asc":sortlist),
		sort: (sort==""?"id":sort),
		order: (order==""?"desc":order),
		sumlist: "nvl(sum(cent0),0) as cent0",
		fieldlist: "a.id,a.operant,a.remark,a.xsnoteno,b.housename,a.notedate,e.housename as fkhousename,f.vtname,d.mobile,d.sex,d.vipno,d.guestname",
		rows: pagecount,
		page: page
	};
	$.ajax({
