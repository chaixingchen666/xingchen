...
<script type="text/javascript" src="/skydesk/js/datagrid-scrollview.js?ver=<%=tools.DataBase.VERSION%>"></script>
...
// 			sortable: true,
			...
			halign: 'center',
			formatter: function(value, row, index) {
				return '<input type="button" class="m-btn" value="删除" onclick="delbrand(' + index + ')">';
			}
		}]],
