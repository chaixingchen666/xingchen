...
<div class="text">
<input class="edithelpinput house_help" id="shousename" data-value="#shouseid" type="text"  placeholder="<输入>" ><span class="s-btn" onclick="selecthouse('search')"></span>
</div>
</div>
...
<!-- 添加与修改盘点管理表单 -->
<div id="ud" title="修改盘点管理单" style="width: 100%;height:100%;" class="easyui-dialog" closed="true" data-qickey>
	<div id="udtool">
	<span id="updatingbar">
	<span><input class="btn4" type="button" data-btn="updatebtn" id="pay" value="提交" onclick="updatewarecheckh()"></span>
	<span class="sepreate"></span>
	...
	<span class="sepreate"></span>
	<span><input class="btn4" type="button" id="hblpd" value="合并临盘单 " onclick="openhblspdd()"></span>
	<span class="sepreate"></span>
	<span><input class="btn4" type="button" id="delete" value="删除单据" onclick="delwarecheckh()"></span>
	</span>
...
<div class="s-box"><div class="title" style="color:#ff7900">*&nbsp;店铺</div>
	<div class="text"><input class="edithelpinput house_help" type="text" id="uhousename" data-value="changenotehouse" >
	<span onclick="selecthouse('update')"></span>
	</div>
	</div>
<div class="s-box"><div class="title">自编号</div>
	...
	<div class="warem-toolbars">
		...
		<tr><td id="warembar" onclick="updown()" style="color:#ff7900">▲&nbsp;&nbsp;商品明细</td><td id="wquickuwaretd"><input type="text" id="wquickuwareno"  class="edithelpinput wid145"  data-end="yes" data-value="quickaddwarem"  placeholder="<选择或输入>" list="wareno_list"><span onclick="if(isAddWarem()){selectware('quickupdatew')}"></span></td></tr>
		</table>
...
<div id="refreshd" title="刷新账面数" style="width: 500px; height: 290px;" class="easyui-dialog" closed="true" data-qickey>
...
<input type="button" class="btn1" value="确定" onclick="refreshwarecheckh();" />
<input type="button" class="btn2" value="取消" onclick="$('#refreshd').dialog('close')" />
</div>
</div>
<div id="loadkcd" title="载入库存" style="width: 500px; height: 450px;" data-options="modal:true" class="easyui-dialog" closed="true" data-qickey>
<div class="textcenter">
...
var getnotelist = function(page) {
	...
	currentdata["erpser"] = "warecheckhlist";
	...
	currentdata["fieldlist"] = "a.id,a.accid,a.noteno,a.notedate,a.houseid,b.housename,a.handno,a.remark,a.totalcurr,a.totalamt,a.operant,a.statetag";
...
function addnoted() {
	...
	$('#udnoteform input[type=hidden]').val('');
	$('#uhouseid').val(getValuebyName('HOUSEID'));
	$('#uhouseanme').val(getValuebyName('HOUSENAME'));
	...
	$('#ud').data('qickey', "F4:'updatewarecheckh()',Del:'delwarecheckh()'");
}
//编辑单据
...
function loadkc() {
	...
	var minretailsale = $('#lminsale').val();
	var maxretailsale = $('#lmaxsale').val();
	typeid = typeid==""?"-1":typeid;
// 	minretailsale = minretailsale==""?-1:Number(minretailsale);
// 	maxretailsale = maxretailsale==""?-1:Number(maxretailsale);
	var onlyfs;
	var loadbj;
...
function gettempchecklist(page) {
	...
	$.ajax({
		...
		data: {
			...
			statetag: 1,
			fieldlist: "a.id,a.accid,a.noteno,a.notedate,a.houseid,b.housename,a.handno,a.remark,a.totalcurr,a.totalamt,a.operant,a.statetag",
			mindate: mindate,
			houseid: houseid,
			rows: pagecount,
			page: page,
