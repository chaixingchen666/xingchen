...
<div class="s-box">
	...
	<div class="text">
	<input type="text" class="edithelpinput provd_help" data-value="#sprovid" name="sprovname" id="sprovname" placeholder="<选择或输入>" > 
	<span onclick="selectdx_prov('search')"></span>
	<input type="hidden" name="sprovid" id="sprovid" value="">
	</div>
	</div>
<div class="s-box">
	<div class="title">区位</div>
	<div class="text">
	<input type="text" class="edithelpinput area_help" data-value="#sareaid" name="sareaname" id="sareaname" placeholder="<选择或输入>" > 
	<span onclick="selectdx_area('search')"></span>
	<input type="hidden" name="sareaid" id="sareaid" value="">
	</div>
	</div>
<div class="s-box">
...
<div class="s-box">
	...
	<div class="text"><select id="sstatetag" class="sele1">
...
<div class="s-box">
	<div class="title">盈亏状态</div>
	<div class="text"><select id="syktag" class="sele1">
					<option value="0">盘亏</option>						
						<option value="1">盘盈</option>						
						<option value="2" selected>盈亏</option>							
...
function resetsearch(){
	...
	var idstr = "#shousename,#shouseid"
		...
		+",#sbrandid,#sseasonname,#sprodyear,#slocale,#sareaid,#sareaname,#sprovid,#sprovname";
	$(idstr).val('');
}
//高级搜索
var searchb = true;
...
var validehzsj = function(ishz,hzname,hzsjname){
	if(ishz&&hzsjname.indexOf("盈亏数")==-1){
		alerttext("汇总项：盈亏数必选");
...
function searchdatas(){
	...
	currentdata["statetag"] = statetag;
	currentdata["yktag"] = yktag;
		...
		success: function(data) { //回调函数，result，返回值 
			try{
				if(valideData(data)){
					...
					if(totalamt||totalbookamt||totalcheckamt){
						data.footer = [{
							ROWNUMBER: "合计",
							AMOUNT: totalamt,
