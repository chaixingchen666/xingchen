...
<div class="s-box"><div class="title" style="color:#ff7900">*&nbsp;店铺</div>
	<div class="text"><input class="edithelpinput" type="text" id="uhousename" data-value="changenotehouse"><span onclick="selecthouse('update')"></span>
	</div>
	</div>
<div class="s-box"><div class="title">自编号</div>
	...
	<div class="warem-toolbars">
		...
		<tr><td id="warembar" onclick="updown()" style="color:#ff7900">▲&nbsp;&nbsp;商品明细</td><td id="wquickuwaretd"><input type="text" id="wquickuwareno" data-value="quickaddwarem"  data-end="yes" class="edithelpinput wid145" placeholder="---选择或输入---" list="wareno_list"><span onclick="if(isAddWarem()){selectware('quickupdatew')}"></span></td></tr>
		</table>
...
$(function() {
	...
	uploader_xls_options.startUpload = function() {
		...
		if (houseid == 0 && isNaN(houseid)) alerttext("请选择店铺！");
