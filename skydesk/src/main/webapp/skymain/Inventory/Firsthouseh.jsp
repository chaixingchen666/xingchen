...
<!-- 添加与修改期初入库表单 -->
<div id="ud" title="编辑期初入库单" style="width: 100%;height:100%;" class="easyui-dialog" closed="true" data-qickey>
	<div id="udtool">
	<span id="updatingbar">
	<span><input class="btn4" type="button" data-btn="updatebtn" id="pay" value="提交" onclick="updatefirsthouseh()"></span>
	<span class="sepreate"></span>
	<span><input class="btn4" type="button" id="delete" value="删除单据" onclick="delfirsthouseh()"></span>
	<span class="sepreate"></span>
	...
	<div class="warem-toolbars">
		...
		<tr><td id="warembar" onclick="updown()" style="cursor: pointer;" color="#ff7900">▲&nbsp;&nbsp;商品明细</td><td id="wquickuwaretd"><input type="text" id="wquickuwareno"  class="edithelpinput wid145"  data-end="yes" data-value="quickaddwarem"  placeholder="---选择或输入---" list="wareno_list"><span onclick="if(isAddWarem()){selectware('quickupdatew')}"></span></td></tr>
		</table>
...
$(function() {
	...
	setuploadserver({
		server: "/skydesk/fyimportservice?importser=addfirsthousemxls",
		xlsmobanname: "firsthouse",
		channel: "firsthouse"
	});
});
var searchb = false;
...
var getnotelist = function(page) {
	...
	currentdata["erpser"] = "firsthousehlist";
...
function addnoted() {
	...
	$('#ud').data('qickey', "F4:'updatefirsthouseh()',Del:'delfirsthouseh()'");
}
//编辑单据
...
function getnotewarem(noteno, page) {
	...
	$.ajax({
		...
		async: false,
		data: {
			erpser: "firsthousemcolorsumlist",
			sizenum: sizenum,
			noteno: noteno,
			sortid: sortid,
			order: order,
