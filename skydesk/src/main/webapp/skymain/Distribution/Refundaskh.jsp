...
<div class="toolbar_box1">
	...
	<input type="text" placeholder="搜索单据号、客户、摘要" class="ipt1" data-end="yes" id="qsnotevalue"  data-enter="getnotedata()">
...
<div id="ud" title="编辑退货申请单" style="width: 100%;heigh:100%;" class="easyui-dialog" closed="true" data-qickey>
	<div id="udtool">
	<span id="updatingbar">
	<span><input class="btn4" type="button" data-btn="updatebtn" id="pay" value="提交" onclick="updaterefundaskh()"></span>
	<span class="sepreate"></span>
	<span><input class="btn4" type="button" id="delete" value="删除单据" onclick="delrefundaskh()"></span>
	<span class="sepreate"></span>
...
$(function() {
	...
	$('#gg').datagrid({
		...
		},
		{
			...
			styler: function(value, row, index) {
				var style = "";
				if(row.THTAG==1) style += "background:url(/skydesk/images/refundouted.png) center center no-repeat; background-size: 80%;"
				return style;
			}
		},
		{
...
function addnoted() {
	...
	$('#ud').dialog('open');
	$('#uhandno,#uremark,#ucustname').removeAttr('readonly');
	...
	addrefundaskh();
	$('#ud').dialog("setTitle",'增加退货申请单');
	$('#ustatetag').val('0');
	$('#ud').dialog('open');
	$('#addnote').removeAttr('disabled');
	$('#ud').data('qickey', "F4:'updaterefundaskh()',F6:'opendisc()',Del:'delrefundaskh()'");
	$('#wquickuwareno').focus();
}
...
var getnotelist = function(page) {
	...
	currentdata["erpser"] = "refundaskhlist";
	...
	currentdata["fieldlist"] = "a.ID,a.NOTENO,a.ACCID,a.NOTEDATE,a.CUSTID,a.HANDNO,a.REMARK,a.OPERANT,a.CHECKMAN,a.STATETAG,a.LASTDATE,a.TOTALAMT,a.TOTALCURR,B.CUSTNAME,B.DISCOUNT,B.PRICETYPE,a.thtag";
