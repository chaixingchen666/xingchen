...
<div class="s-box">
	<div class="title">调入店铺</div>
	<div class="text"><input type="text" class="edithelpinput house_help" name="stohousename" data-value="#stohouseid"
					id="stohousename" data-options="required:true" placeholder="<选择或输入>" ><span onclick="selectdx_house('searchto')"></span>
					<input type="hidden" id="stohouseid" value="">
	</div>
	</div>
...
<div class="s-box">
	...
	<div class="text"><input type="text" class="wid160 hig25" name="swarename" id="swarename" maxlength="20" placeholder="<输入>" >
	</div>
	</div>
...
function resetsearch(){
	...
	$('#smindate,#smaxdate').datebox('setValue', myDate.Format('yyyy-MM-dd')); // 设置日期输入框的值
	$('#sntid').val('2');
	var idstr = "#stohousename,#stohouseid,#shousename,#shouseid"
...
function searchdatas(){
	...
	var houseid = $("#shouseid").val();//调出店铺
	var tohouseid = $("#stohouseid").val();//调入店铺
	...
	currentdata["tohouseidlist"] = tohouseid;
