...
<div class="s-box">
	...
	<div class="text"><input type="text" class="edithelpinput house_help" name="sfromhousename" data-value="#sfromhouseid"
					id="sfromhousename" data-options="required:true" placeholder="<选择或输入>" ><span onclick="selectdx_house('searchfrom')"></span>
					<input type="hidden" id="sfromhouseid" value="">
	</div>
	</div>
<div class="s-box">
...
function resetsearch(){
	...
	$('#smindate,#smaxdate').datebox('setValue', myDate.Format('yyyy-MM-dd')); // 设置日期输入框的值
	$('#sntid').val('2');
	var idstr = "#sfromhousename,#sfromhouseid,#shousename,#shouseid"
...
function searchdatas(){
	...
	var fromhouseid = $("#sfromhouseid").val();//调出店铺
	...
	currentdata["fromhouseidlist"] = fromhouseid;
