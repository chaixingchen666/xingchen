...
var getnotelist = function(page) {
	...
	currentdata["erpser"] = "paydisclist";
	...
	currentdata["fieldlist"] = "a.id,a.noteno,a.notedate,b.provname,b.provid,a.curr,a.gdcurr,a.handno,a.remark,a.statetag,a.lastop,d.houseid,d.housename,a.operant,a.checkman";
...
function updatenote(statetag) {
	...
	var erpser = "updatepaydiscbyid";
	if(noteno.length==0) erpser="addpaydisc";
	var dofn = function() {
		alertmsg(2);
		$.ajax({
			type: "POST",
