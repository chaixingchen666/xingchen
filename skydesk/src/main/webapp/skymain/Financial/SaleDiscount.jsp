...
var getnotelist = function(page) {
	...
	currentdata["erpser"] = "incomedisclist";
	...
	currentdata["fieldlist"] = "a.id,a.noteno,a.notedate,b.custname,b.custid,a.curr,a.gdcurr,a.handno,a.remark,a.statetag,a.lastop,d.houseid,d.housename,a.operant,a.checkman";
...
function updatenote(statetag) {
	...
	var erpser = "updateincomediscbyid";
	if(noteno.length==0) erpser="addincomedisc";
	var dofn = function() {
		alertmsg(2);
		$.ajax({
			type: "POST",
