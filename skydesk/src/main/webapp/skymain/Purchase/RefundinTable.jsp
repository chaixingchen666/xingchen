...
<input type="button" id="highsearch" class="btn2" value="条件搜索" onclick="toggle()">
	...
	<div id="hsearch" class="searchbar"  data-enter="searchdata();toggle();" style="clear:both;width:100%;">
		...
		<select id="shzfs"  style="width: 164px; height: 25px">
			<option value="0" selected="selected" color="#ff7900">*&nbsp;供应商</option>
			<option value="1" color="#ff7900">*&nbsp;店铺</option>
		...
		<div class="text">
		<input type="text" class="edithelpinput" id="sfullname" data-value="#stypeid" name="sfullname" placeholder="<选择或输入>">
