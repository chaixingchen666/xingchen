...
function resetsearch(){
	...
	$('#smindate,#smaxdate').datebox('setValue', myDate.Format('yyyy-MM-dd')); // 设置日期输入框的值
	$('#sntid').val('2');
	var idstr = "#sprovname,#sprovid,#shousename,#shouseid,#swareno"
	+",#swareid,#swarename,#sbrandname,#sbrandid,#sseasonname"
	+",#sprodyear,#slocale,#snoteno";
	$(idstr).val('');
}
//高级搜索
var searchb = true;
