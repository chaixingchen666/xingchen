 ...
 * 调用：会员,会员商城，采购商城，采购后台接口，销售计划，账本,促销方案
 */
@WebServlet("/fybuyjerp")
public class FyBuyJerp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			fHttp.setHostIP(DataBase.JERPIP+"buy?action=");
			if(timeout!=null){
			...
			e.printStackTrace();
			LogUtils.LogWrite("ErorRequestData4", dataobj.toString());
			resobj.put("result", 0);
			resobj.put("msg", "请求返回数据格式异常！(E008)");
		}
