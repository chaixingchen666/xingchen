...
public class vTotalJxckhmx {
	...
	// 商品+颜色+尺码记录明细
	public int Total2(int qxbj, int maxday) {
		...
		// System.out.println("mindate="+Mindate+" maxdate="+Maxdate+" mindate0="+mindate0+" Serverdatetime="+Serverdatetime+" Accbegindate="+Accbegindate);
		if (Provid >= 0)
		...
		qry += "\n    left outer join custcost f on a.custid=f.custid and a.wareid=f.wareid and a.daystr=f.daystr";
		...
		qry += "\n    union all";
		// --初始入库
		// qry += "\n insert into v_cxjxcmx_temp (notedate,remark,noteno,wlremark,notetype,amount0,curr0,amount1,amount2) ";
		// qry += "\n select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss'),cast('初始' as nvarchar2(100)),a.noteno,d.housename ,'QC',sum(b.amount),sum(b.curr),0,0 ";

		qry += "\n    select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss') as notedate,cast('初始' as nvarchar2(100)) as remark,a.noteno ,'KQ' as notetype ,d.custname as wlremark";
		...
		qry += "\n    left outer join customer d on a.custid=d.custid ";
		qry += "\n    left outer join custcost f on a.custid=f.custid and b.wareid=f.wareid and f.daystr=to_char(a.notedate,'yyyy-mm-dd')";
		...
		// --批发入库
		// qry += "\n insert into v_cxjxcmx_temp (notedate,remark,noteno,wlremark,notetype,amount0,curr0,amount1,amount2) ";
		// qry += "\n select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss'),cast('采购' as nvarchar2(100)),a.noteno,e.provname||'->'||d.housename,'CG',sum(b.amount),sum(b.curr),0,0 ";
		...
		if (Prodyear.length() > 0)
			qry += "\n      and c.prodyear='" + Prodyear + "'";
		// qry += "\n group by a.notedate,a.noteno,d.housename,e.provname||'->'||d.housename";

		qry += "\n    union all";
		// --批发退库
		// qry += "\n insert into v_cxjxcmx_temp (notedate,remark,noteno,wlremark,notetype,amount0,curr0,amount1,amount2) ";
		// qry += "\n select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss'),cast('采购退货' as nvarchar2(100)),a.noteno,d.housename||'->'||e.provna+me ,'CT',-sum(b.amount),-sum(b.curr),0,0 ";
		...
		qry += "\n    union all";
		// qry += "\n insert into v_cxjxcmx_temp (notedate,remark,noteno,wlremark,notetype,amount0,curr0,amount1,amount2) ";
		qry += "\n    select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss'),cast('盘盈' as nvarchar2(100)),a.noteno,'KP' as notetype,d.custname";
		qry += "\n    ,b.wareid,b.colorid,b.sizeid";
		...
		qry += "\n    left outer join custcost f on a.custid=f.custid and b.wareid=f.wareid and f.daystr=to_char(a.notedate,'yyyy-mm-dd')";
		qry += "\n    where a.statetag=1 ";// and to_char(a.notedate,'yyyy-mm-dd') >='"+mindate+"' ";
		qry += "\n    and b.amount>0 ";// and to_char(a.notedate,'yyyy-mm-dd') <=v_maxdate ";
		qry += "\n    and a.notedate>=to_date('" + Mindate + "','yyyy-mm-dd') and a.notedate<=to_date('" + Maxdate + " 23:59:59','yyyy-mm-dd hh24:mi:ss')";
		...
		// 客户销售
		qry += "\n    union all";
		// qry += "\n insert into v_cxjxcmx_temp (notedate,remark,noteno,wlremark,notetype,amount0,amount1,currxs,amount2) ";
		// qry += "\n select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss'),cast('批发' as nvarchar2(100)),a.noteno,d.housename||'->'||e.custname,'XS',0,sum(b.amount),sum(b.curr),0 ";
		qry += "\n    select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss'),cast('客户销售' as nvarchar2(100)),a.noteno,'KX' as notetype,e.custname";
		qry += "\n    ,b.wareid,b.colorid,b.sizeid";
...
//		qry += "\n    left outer join warehouse d on a.houseid=d.houseid ";
		...
		// --盘亏
		qry += "\n    union all";
		// qry += "\n insert into v_cxjxcmx_temp (notedate,remark,noteno,wlremark,notetype,amount0,amount1,curr1,amount2) ";
		// qry += "\n select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss'),cast('盘亏' as nvarchar2(100)),a.noteno,d.housename,'PK',0,-sum(b.amount),-sum(b.curr),0 ";
		qry += "\n    select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss'),cast('盘亏' as nvarchar2(100)),a.noteno,'KP' as notetype,d.custname";
		qry += "\n    ,b.wareid,b.colorid,b.sizeid";
		...
		// qry += "\n group by a.notedate,a.noteno,d.housename ";
		qry += "\n  ); ";
		// qry += "\n insert into v_cxjxcmx_data (id,epid,notedate,noteno,notetype,remark,wlremark,amount0,curr0,amount1,curr1,currxs,amount2) ";
		// qry += "\n (select v_cxjxcmx_data_id.nextval," + Userid
		// + ", notedate,noteno,notetype,remark,wlremark,nvl(amount0,0),nvl(curr0,0),nvl(amount1,0),nvl(curr1,0),nvl(currxs,0),nvl(amount2,0) from v_cxjxcmx_temp); ";
		// --计算余额
	...
	// 商品颜色汇总
	public int Total1(int qxbj, int cxfs, int maxday) {
		// cxfs:，1=商品汇总，2=商品+颜色
		// 校验开始查询日期
		MinDateValid mdv = new MinDateValid(Mindate, Func.subString(Serverdatetime, 1, 10), Accbegindate, maxday);
		Mindate = mdv.getMindate();
		...
		qry += "\n    from custsum a ";
		qry += "\n    left outer join warecode b on a.wareid=b.wareid ";
		qry += "\n    left outer join custcost f on a.custid=f.custid and a.wareid=f.wareid and f.daystr=a.daystr";
...
//			qry += " and f.houseid=0";
		...
		if (Prodyear.length() > 0)
			qry += "\n      and c.prodyear='" + Prodyear + "'";
		qry += "\n    group by a.notedate,a.noteno,d.custname";
		if (cxfs == 1)
			qry += ", b.wareid";
		else
			qry += ",b.wareid,b.colorid";
		...
		if (Prodyear.length() > 0)
			qry += "\n      and c.prodyear='" + Prodyear + "'";
		qry += "\n    group by a.notedate,a.noteno,d.housename,d.housename||'->'||e.custname";
		if (cxfs == 1)
			qry += ", b.wareid";
		else
			qry += ",b.wareid,b.colorid";
...
//		qry += "\n    left outer join warehouse d on a.houseid=d.houseid ";
		qry += "\n    left outer join customer e on a.custid=e.custid ";
		qry += "\n    left outer join custcost f on a.custid=f.custid and b.wareid=f.wareid and f.daystr=to_char(a.notedate,'yyyy-mm-dd')";
		qry += "\n    where a.statetag=1 and a.accid=" + Accid ;// and to_char(a.notedate,'yyyy-mm-dd') >='"+mindate+"' ";
		// qry+=" and to_char(a.notedate,'yyyy-mm-dd') <=v_maxdate ";
		qry += "\n    and a.notedate>=to_date('" + Mindate + "','yyyy-mm-dd') and a.notedate<=to_date('" + Maxdate + " 23:59:59','yyyy-mm-dd hh24:mi:ss')";
		...
		if (Prodyear.length() > 0)
			qry += "\n      and c.prodyear='" + Prodyear + "'";
		qry += "\n    group by a.notedate,a.noteno,e.custname ";
		if (cxfs == 1)
			qry += ", b.wareid";
		else
			qry += ",b.wareid,b.colorid";
	...
	// 单据汇总
	public int Total(int qxbj, int cxfs, int maxday) {

		// cxfs:0=单据汇总，1=商品汇总，2=商品+颜色，3=商品+颜色+尺码
		if (cxfs == 3) {
			return Total2(qxbj, maxday);
		} else if (cxfs == 1 || cxfs == 2) {
			return Total1(qxbj, cxfs, maxday);
		...
		if (Calcdate.length() > 0 && Calcdate.compareTo(mindate0) < 0) {
			...
			// 计算库存
			vTotalkhkczy kc = new vTotalkhkczy();
			kc.setAccid(Accid);
			kc.setUserid(Userid);
		...
		if (bj == 1) {
			...
			qry += "\n    left outer join warecode b on a.wareid=b.wareid ";
			qry += "\n    left outer join custcost f on a.custid=f.custid and a.wareid=f.wareid and f.daystr='" + mindate0 + "'";
			qry += "\n    where a.epid=" + Userid;
		} else {
			qry += "\n    select ' ' as notedate,cast('期初' as nvarchar2(100)) as remark,cast(' ' as nvarchar2(20)) as noteno,'' as notetype,cast(' ' as nvarchar2(20)) as wlremark";
			qry += "\n    ,0 as amount0,0 as curr0,0 as currrk,0 as amount1,0 as curr1,0 as currxs,nvl(sum(a.amount),0) as amount2,nvl( sum(round(a.amount*f.costprice,2)) ,0) as curr2 ";
		...
		qry += "\n    select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss') as notedate,cast('初始' as nvarchar2(100)) as remark,a.noteno ,'QC' as notetype ,d.custname as wlremark";
		qry += "\n    ,sum(b.amount) as amount0,sum(b.curr) as curr0,sum(b.curr) as currrk,0 as amount1,0 as curr1,0 as currxs ,0 as amount2,0 as curr2";
		...
		qry += "\n    union all";
		// qry += "\n insert into v_cxjxcmx_temp (notedate,remark,noteno,wlremark,notetype,amount0,curr0,amount1,amount2) ";
		qry += "\n    select to_char(a.notedate,'yyyy-mm-dd hh24:mi:ss'),cast('盘盈' as nvarchar2(100)),a.noteno,'KY' as notetype,d.custname";
		qry += "\n    ,sum(b.amount) as amount0,nvl(sum(b.amount*f.costprice),0) as curr0,sum(b.curr) as currrk,0 as amount1,0 as curr1,0 as currxs ,0 as amount2,0 as curr2 ";
		qry += "\n    from custcheckh a  ";
		qry += "\n    join custcheckm b on a.accid=b.accid and a.noteno=b.noteno  ";
		qry += "\n    left outer join warecode c on b.wareid=c.wareid ";
