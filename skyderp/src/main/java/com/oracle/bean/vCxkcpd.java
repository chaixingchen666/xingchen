...
public class vCxkcpd {
	...
	private Integer Statetag = 1;// 0=未提交，1=已提交，2=所有
	private Integer Yktag = 2;// 0=盘亏，1=盘盈，2=盈亏，3=所有
	...
	public String GetTable2Json(QueryParam qp, int sizenum) {
		...
		for (int i = 0; i < rows; i++) {
			...
			strSql1.append("\n FROM warecheckm a");
			strSql1.append("\n join warecheckh b on a.accid=b.accid and a.noteno=b.noteno");
			...
			strSql1.append("\n where a.accid=" + Accid);
			if (Statetag < 2)// Statetag : 0=未提交，1=已提交，2=所有
				strSql1.append("\n and b.statetag=" + Statetag);

			// Yktag : 0=盘亏，1=盘盈，2=盈亏，3=所有
			if (Yktag == 0)
				strSql1.append("\n and a.amount<0");
			else if (Yktag == 1)
				strSql1.append("\n and a.amount>0");
