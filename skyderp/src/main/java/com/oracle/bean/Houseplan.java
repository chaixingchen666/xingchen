...
//*************************************
//  @author:sunhong  @date:2017-03-22 21:08:47
//*************************************
public class Houseplan implements java.io.Serializable {
	...
	public int Delete() {
		...
		// }
		// strSql.setLength(0);
		// strSql.append(" update houseplan set statetag=2,lastop='" + Lastop + "',lastdate=sysdate");
	...
	public int Append() {
		...
		strSql.append(" begin ");
		strSql.append("   v_id:=houseplan_id.nextval; ");
		strSql.append("   insert into houseplan (");
	...
	public int Update() {
		StringBuilder strSql = new StringBuilder();
		strSql.append("begin ");
		strSql.append("   update houseplan set ");
		if (Houseid != null) {
	...
	public Table GetTable(QueryParam qp, String strWhere, String fieldlist) {
		StringBuilder strSql = new StringBuilder();
		strSql.append("select " + fieldlist);
		strSql.append(" FROM houseplan  a join warehouse b on a.houseid=b.houseid");
		if (!strWhere.equals("")) {
			strSql.append(" where " + strWhere);
		}
	...
	public boolean Exists() {
		StringBuilder strSql = new StringBuilder();
		strSql.append("select count(*) as num  from houseplan");
	...
	public int Save() {
		...
		qry += " begin ";
		qry += "   begin ";
		qry += "     select houseid into v_houseid  from warehouse where houseid=" + Houseid + " and accid=" + Accid + ";";
		qry += "   EXCEPTION WHEN NO_DATA_FOUND THEN";
		qry += "     v_retcs:='0店铺无效' ; ";
		qry += "     goto exit;";
		qry += "   end; ";

		qry += "    select count(*) into v_count from houseplan where houseid=" + Houseid + " and yearnum=" + Yearnum + "; ";
		qry += "    if v_count=0  then";
		qry += "       insert into houseplan (houseid,yearnum,curr,curr1,curr2,curr3,curr4,curr5,curr6,curr7,curr8,curr9,curr10,curr11,curr12,lastop,lastdate) ";
		qry += "       values (" + Houseid + "," + Yearnum + "," + Curr + "," + Curr1 + "," + Curr2 + "," + Curr3 + "," + Curr4 + "," + Curr5 + "," + Curr6 + "," + Curr7 + "," + Curr8 + "," + Curr9 + "," + Curr10 + ","
				+ Curr11 + "," + Curr12 + ",'" + Lastop + "',sysdate); ";
		qry += "    else ";
		qry += "       update houseplan set curr =" + Curr + ",curr1=" + Curr1 + ",curr2=" + Curr2 + ",curr3=" + Curr3 + ",curr4=" + Curr4 + ",curr5=" + Curr5 + ",curr6=" + Curr6;
		qry += "       ,curr7=" + Curr7 + ",curr8=" + Curr8 + ",curr9=" + Curr9 + ",curr10=" + Curr10 + ",curr11=" + Curr11 + ",curr12=" + Curr12;
		qry += "       ,lastop='" + Lastop + "',lastdate=sysdate";
		qry += "       where houseid=" + Houseid + " and yearnum=" + Yearnum + "; ";
		qry += "    end if; ";
		qry += "    v_retcs:= '1操作成功!'; ";
		qry += "    <<exit>>";
